        ...
        <div class="relative flex h-16 items-center justify-between">
          ...
          <div class="hidden lg:block lg:w-80">
            <div class="flex items-center justify-end">
              <div class="flex">
                <a href="#"
                  class="rounded-md px-3 py-2 text-sm font-medium text-indigo-200 hover:text-white">Documentation</a>
              ...
              <Menu as="div" class="relative ml-4 flex-shrink-0">
                ...
                <transition enter-active-class="transition ease-out duration-100"
                  ...
                  <MenuItems
                    ...
                    <a href="#" :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700']">View
                      Profile</a>
                    </MenuItem>
                    <MenuItem v-slot="{ active }">
                    <a href="#"
      ...
      <DisclosurePanel class="lg:hidden">
        <div class="px-2 pt-2 pb-3">
          <DisclosureButton as="a" href="#"
            class="block rounded-md bg-indigo-800 px-3 py-2 text-base font-medium text-white">Dashboard</DisclosureButton>
          <DisclosureButton as="a" href="#"
