<template>
    <div class="bg-white">
        ...
        <main>
            ...
            <div class="relative">
                <div
                    ...
                    <div class="slide aspect-square h-full w-full flex-shrink-0 snap-center rounded overflow-hidden">
                        ...
                        <div class="mx-auto max-w-full sm:px-6 lg:px-0">
                        ...
                        <div class="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0">
                            <div>
                                ...
                                <div class="mt-6">
                                    ...
                                    <div class="mt-6">
                                        <a href="#"
                                            class="inline-flex rounded-md border border-transparent bg-gradient-to-r from-yellow-600 to-amber-600 bg-origin-border px-4 py-2 text-base font-medium text-white shadow-sm hover:from-yellow-700 hover:to-amber-700">Get
                                            started</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <blockquote>
                                    <div>
                                        <p class="text-base text-gray-500">&ldquo;Cras velit quis eros eget rhoncus lacus
                                            ultrices sed diam. Sit orci risus aenean curabitur donec aliquet. Mi venenatis
                                            in euismod ut.&rdquo;</p>
                                    </div>
                                    <footer class="mt-3">
            ...
            <div class="bg-gradient-to-r from-yellow-800 to-amber-700">
                <div class="mx-auto max-w-4xl py-16 px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:px-8 lg:pt-24">
                    ...
                    <p class="mt-4 max-w-3xl text-lg text-yellow-200">Ac tincidunt sapien vehicula erat auctor pellentesque
                    ...
                    <div
                        ...
                        <div v-for="feature in features" :key="feature.name">
                            ...
                            <div class="mt-6">
                                ...
                                <p class="mt-2 text-base text-yellow-200">{{ feature.description }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
                        <h2 class="text-base font-semibold">
                            <span
                                class="bg-gradient-to-r from-yellow-300 to-amber-300 bg-clip-text text-transparent">Valuable
                                Metrics</span>
                        </h2>
                        <p class="mt-3 text-3xl font-bold tracking-tight text-white">Get actionable data that will help grow
                            your business</p>
                        ...
                        <div class="mt-12 grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2">
                            <p v-for="item in metrics" :key="item.id">
                                ...
                                <span class="mt-1 block text-base text-gray-300"><span class="font-medium text-white">{{
                                    item.emphasis }}</span> {{ item.rest }}</span>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white">
                <div
                    ...
                    <h2 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                        ...
                        <span
                            class="-mb-1 block bg-gradient-to-r from-yellow-600 to-amber-600 bg-clip-text pb-1 text-transparent">Get
                            in touch or create an account.</span>
                    </h2>
                    <div class="mt-6 space-y-4 sm:flex sm:space-y-0 sm:space-x-5">
                        <a href="#"
                            class="flex items-center justify-center rounded-md border border-transparent bg-gradient-to-r from-yellow-600 to-amber-600 bg-origin-border px-4 py-3 text-base font-medium text-white shadow-sm hover:from-yellow-700 hover:to-amber-700">Learn
                            more</a>
                        <a href="#"
                            class="flex items-center justify-center rounded-md border border-transparent bg-amber-50 px-4 py-3 text-base font-medium text-amber-800 shadow-sm hover:bg-amber-100">Get
                            started</a>
                    </div>
                </div>
            </div>
