...
@section('content')
    <div class="mx-auto">
        <bannercomponent status="1" data="test" src="images/Statistics/01_Agriculture/Banner-Agriculture.jpg">
        </bannercomponent>
    </div>
    <div class="mx-auto mb-5 mt-16 w-full">
        <div class="grid grid-cols-1 px-4 md:px-20 ">
            ...
            <div class="grid grid-cols-1 gap-24 justify-items-end mb-10">
